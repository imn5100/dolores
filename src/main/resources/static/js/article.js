    ...
    htmlEditor = $('.summernote').summernote({
        ...
        callbacks:{
            onImageUpload: function(files) {
                ...
                data.append('uploadMode', ($("#uploadMode").attr('on') === 'true' ? 1 : 0));
                tale.showLoading();
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        if(result && result.success){
                            var url = (result.payload[0].fkey.startsWith("http") ? "" : $('#attach_url').val()) + result.payload[0].fkey;
                            console.log('url =>' + url);
    ...
    $("#dropzone").dropzone({
        ...
        init: function() {
            ...
            this.on('sending', function(file, xhr, formData){
                formData.append("uploadMode", ($("#uploadMode").attr('on') === 'true'? 1 : 0));
            });
        }
    });
